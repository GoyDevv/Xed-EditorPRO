        ...
        text = {
            Column(
                ...
                if (template.showsPackageName) {
                    ...
                    // Live preview of the resolved applicationId / package, plus a warning when the
                    // fields are empty so the user knows what will be auto-generated.
                    val resolvedPkg =
                        ProjectConfig(
                            ...
                            .resolvedPackageName()
                    val pkgAutoGenerated = packageName.isBlank()
                    Text(
                        text = stringResource(strings.package_name_preview) + ": " + resolvedPkg,
                        style = MaterialTheme.typography.bodySmall,
                        color =
                            if (pkgAutoGenerated) MaterialTheme.colorScheme.tertiary
                            else MaterialTheme.colorScheme.onSurfaceVariant,
                    )
                    if (packageName.isBlank() && author.isBlank()) {
                        Text(
