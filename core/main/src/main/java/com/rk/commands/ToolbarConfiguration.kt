...
object ToolbarConfiguration {
    const val DEFAULT_EDITOR_TOOLBAR_COMMANDS =
        "editor.undo|editor.redo|editor.save|editor.run|editor.sync|editor.markdown_preview|editor.dependencies|editor.show_all_files|editor.toggle_extra_keys|global.new_file|editor.editable|editor.search|editor.refresh|global.terminal|global.settings"
